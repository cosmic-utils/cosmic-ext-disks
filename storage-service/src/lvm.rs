...
impl LVMHandler {
    ...
    async fn list_volume_groups(
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("vgs command failed: {stderr}")));
        }
    ...
    async fn list_logical_volumes(
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("lvs command failed: {stderr}")));
        }
    ...
    async fn list_physical_volumes(
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("pvs command failed: {stderr}")));
        }
    ...
    async fn create_volume_group(
        ...
        if devices.is_empty() {
            return Err(zbus::fdo::Error::InvalidArgs("At least one device required".to_string()));
        }
        
        tracing::info!("Creating volume group '{}' with devices: {:?}", vg_name, devices);
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("vgcreate failed: {stderr}")));
        }
    ...
    async fn create_logical_volume(
        ...
        tracing::info!("Creating logical volume '{}/{}' with size {} bytes", vg_name, lv_name, size_bytes);
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("lvcreate failed: {stderr}")));
        }
    ...
    async fn resize_logical_volume(
        ...
        tracing::info!("Resizing logical volume '{}' to {} bytes", lv_path, new_size_bytes);
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("lvresize failed: {stderr}")));
        }
    ...
    async fn delete_volume_group(
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("vgremove failed: {stderr}")));
        }
    ...
    async fn delete_logical_volume(
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("lvremove failed: {stderr}")));
        }
    ...
    async fn remove_physical_volume(
        ...
        tracing::info!("Removing physical volume '{}' from volume group '{}'", pv_device, vg_name);
        ...
        if !output.status.success() {
            ...
            return Err(zbus::fdo::Error::Failed(format!("vgreduce failed: {stderr}")));
        }
        
        tracing::info!("Physical volume '{}' removed from volume group '{}'", pv_device, vg_name);
