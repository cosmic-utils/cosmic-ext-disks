...
settings-enable-udisks-btrfs =	Tentative d'activation du module BTRFS UDisks2
settings-udisks-btrfs-enabled =	Module BTRFS UDisks2 activé
settings-udisks-btrfs-enabled-body =	Le module BTRFS UDisks2 a été activé avec succès. Vous pouvez désormais utiliser les fonctionnalités de gestion BTRFS.
settings-udisks-btrfs-failed =	Échec de l'activation du module BTRFS UDisks2
