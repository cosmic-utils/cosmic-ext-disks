...
| N/A | Modal dialog windows (all dialogs as separate OS windows) | `.copi/specs/feature/modal-dialogs/` | `feature/modal-dialogs` | README V1 goal #1; user request 2026-02-12 | Spec created (11 tasks, 30-49h) |
| N/A | BTRFS management tools (subvolumes, snapshots, usage breakdown, compression info) | `.copi/specs/feature/btrfs-tools/` | `feature/btrfs-tools` | README V1 goal #3; user request 2026-02-12 | Spec created (9 tasks, 23-34h; BLOCKED on modal-dialogs) |
