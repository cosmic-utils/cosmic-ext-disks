...
| N/A | Storage Service D-Bus architecture (replace pkexec with system service, Polkit auth, socket activation, async operations) | `.copi/specs/feature/storage-service/` | `feature/storage-service` | N/A (major refactor; 2026-02-13) | Phase 1 Complete (library + service created) |
