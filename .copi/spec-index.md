...
| N/A | Storage Service D-Bus architecture (replace pkexec with system service, Polkit auth, socket activation, async operations) | `.copi/specs/feature/storage-service/` | `feature/storage-service` | N/A (major refactor; 2026-02-13) | Phase 1-2 Complete (BTRFS ops, architecture, models) |
| N/A | Storage Service Phase 3: Disk & Partition Operations (UDisks2 integration, partitions, filesystems, LVM, SMART, encryption) | `.copi/specs/feature/storage-service/disk-partition-ops-plan.md` | `feature/storage-service` | N/A (breadth expansion; 2026-02-13) | Planned (72 tasks: Phase 3A refactor disks-dbus 15 tasks 2-3wks + Phase 3B implement service 57 tasks 8-10wks) |
