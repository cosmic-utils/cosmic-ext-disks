...
| N/A | Modal dialog windows (all dialogs as separate OS windows) | `.copi/specs/feature/modal-dialogs/` | N/A (deferred) | README V1 goal #1; user request 2026-02-12 | Deferred (waiting for upstream libcosmic support) |
| N/A | BTRFS management tools (subvolumes, snapshots, usage breakdown, compression info) | `.copi/specs/feature/btrfs-tools/` | `feature/btrfs-mgmt` | README V1 goal #3; user request 2026-02-12 | Spec created (9 tasks, 23-34h) |
| N/A | BTRFS V2.1-2.2 feature roadmap (read-only toggle, timestamps, auto-naming, sort/filter, bulk ops, quota/compression, defrag, balance/scrub/check, transfer) | `.copi/specs/feature/btrfs-features/` | TBD (per-feature branches) | N/A (roadmap; 2026-02-13) | Planned (10 features) |
| N/A | Storage Service D-Bus architecture (replace pkexec with system service, Polkit auth, socket activation, async operations) | `.copi/specs/feature/storage-service/` | `feature/storage-service` | N/A (major refactor; 2026-02-13) | Phase 1-2 Complete (BTRFS ops, architecture, models); **Phase 3A Complete (Tasks 1-11: storage-models types & conversions)** |
| N/A | Storage Service Phase 3B: Implement D-Bus Service Interface (expose storage-dbus operations via service, UDisks2 integration, partitions, filesystems, LVM, SMART, encryption) | `.copi/specs/feature/storage-service/disk-partition-ops-plan.md` | `feature/storage-service` | N/A (breadth expansion; 2026-02-13) | Planned (57 tasks, 8-10 weeks) - Prerequisites: Phase 3A complete ✅ |
