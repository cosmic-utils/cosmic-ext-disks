...
| N/A | Unmount resource busy error recovery with lsof detection and kill options | `.copi/specs/feature/unmount-busy-error-recovery/` | `feature/unmount-busy-error-recovery` | N/A (brief; 2026-02-11) | Spec created |
