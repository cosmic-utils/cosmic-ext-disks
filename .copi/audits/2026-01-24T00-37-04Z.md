...
- UDisks2 polling manager proxy: [storage-dbus/src/disks/manager.rs](../../storage-dbus/src/disks/manager.rs)
...
- **Evidence (facts):**
  - Cancel button emits `CreateMessage::Cancel`: [storage-ui/src/views/dialogs.rs#L107](../../storage-ui/src/views/dialogs.rs#L107)
  - Handler is `todo!()` for cancel: [storage-ui/src/views/volumes.rs#L386](../../storage-ui/src/views/volumes.rs#L386)
...
- **Evidence (facts):** `None => panic!("invalid state")` in dialog update: [storage-ui/src/views/volumes.rs#L363](../../storage-ui/src/views/volumes.rs#L363)
...
- **Evidence (facts):** Unimplemented actions in update handler: [storage-ui/src/app.rs#L532-L542](../../storage-ui/src/app.rs#L532-L542)
...
- **Evidence (facts):**
  - Create-partition chooses DOS types only when table type is `"msdos"`: [storage-dbus/src/disks/drive.rs#L270-L276](../../storage-dbus/src/disks/drive.rs#L270-L276)
  - Partition types list uses `"dos"` as the table type: [storage-dbus/src/partition_type.rs#L67-L113](../../storage-dbus/src/partition_type.rs#L67-L113)
  - UI passes through `drive.partition_table_type` into create info: [storage-ui/src/views/volumes.rs#L93-L145](../../storage-ui/src/views/volumes.rs#L93-L145)
...
- **Evidence (facts):** [storage-ui/src/views/volumes.rs#L536](../../storage-ui/src/views/volumes.rs#L536)
...
- **Evidence (facts):**
  ...
  - UI uses presence/absence of usage as mount indicator: [storage-ui/src/views/volumes.rs#L470-L476](../../storage-ui/src/views/volumes.rs#L470-L476)
...
- **Evidence (facts):** `device_event_stream(Duration::from_secs(1))` usage in UI: [storage-ui/src/app.rs#L351](../../storage-ui/src/app.rs#L351); polling loop in manager: [storage-dbus/src/disks/manager.rs](../../storage-dbus/src/disks/manager.rs)
...
- **Evidence (facts):** stubs in [storage-dbus/src/disks/partition.rs#L175-L283](../../storage-dbus/src/disks/partition.rs#L175-L283)
...
- Replace user-facing `todo!()`/`panic!()` paths with safe no-ops + user-visible error banners.
  - Key targets: [storage-ui/src/app.rs#L532-L542](../../storage-ui/src/app.rs#L532-L542), [storage-ui/src/views/volumes.rs#L363-L386](../../storage-ui/src/views/volumes.rs#L363-L386)
- Fix table-type normalization (`dos` vs `msdos`) or explicitly disable DOS partition creation with a clear message.
  - Key target: [storage-dbus/src/disks/drive.rs#L270-L286](../../storage-dbus/src/disks/drive.rs#L270-L286)
- Swap `df`-based mount detection for UDisks2 mount points.
  - Key target: [storage-dbus/src/usage.rs#L16](../../storage-dbus/src/usage.rs#L16)
...
- [storage-ui/src/views/menu.rs](../../storage-ui/src/views/menu.rs)
...
- [storage-dbus/src/disks/manager.rs](../../storage-dbus/src/disks/manager.rs)
