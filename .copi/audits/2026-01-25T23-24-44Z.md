...
- The UI state machine is concentrated in two very large files ([disks-ui/src/app.rs](../disks-ui/src/app.rs) ~1780 LOC, [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs) ~2750 LOC), creating high coupling and making it hard to reason about correctness.
- Dialog state, dialog views, and domain operations are tightly interwoven across modules (e.g., [disks-ui/src/app.rs](../disks-ui/src/app.rs) ↔ [disks-ui/src/views/dialogs.rs](../disks-ui/src/views/dialogs.rs) ↔ [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs)), resulting in a “ball of mud” hierarchy.
- In `disks-dbus`, responsibilities are mixed inside large “model” modules (e.g., [disks-dbus/src/disks/drive.rs](../disks-dbus/src/disks/drive.rs) bundles enumeration, SMART, image/loop handling, format/remove/preflight).
- The partition type catalog is a giant in-code static table ([disks-dbus/src/partition_type.rs](../disks-dbus/src/partition_type.rs) ~2070 LOC), making it hard to localize, test, or evolve.
...
### Entrypoints
- UI app entry: [disks-ui/src/main.rs](../disks-ui/src/main.rs)
- UI model/runtime integration: [disks-ui/src/app.rs](../disks-ui/src/app.rs)
- DBus abstraction crate public surface: [disks-dbus/src/lib.rs](../disks-dbus/src/lib.rs)

### Public interfaces / major modules
- UI views: [disks-ui/src/views](../disks-ui/src/views)
  - Primary interaction surface: [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs)
  - Dialog rendering: [disks-ui/src/views/dialogs.rs](../disks-ui/src/views/dialogs.rs)
- DBus/domain “models” and operations: [disks-dbus/src/disks](../disks-dbus/src/disks)
  - Drive discovery + actions: [disks-dbus/src/disks/drive.rs](../disks-dbus/src/disks/drive.rs)
  - Partition model + mount options: [disks-dbus/src/disks/partition.rs](../disks-dbus/src/disks/partition.rs)
  - Nested volume tree (LUKS/LVM): [disks-dbus/src/disks/volume.rs](../disks-dbus/src/disks/volume.rs)
  - Backend ops abstraction: [disks-dbus/src/disks/ops.rs](../disks-dbus/src/disks/ops.rs)
- Partition type catalog: [disks-dbus/src/partition_type.rs](../disks-dbus/src/partition_type.rs)

### Largest complexity hotspots (LOC)
(From `wc -l`)
- [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs): 2751
- [disks-dbus/src/partition_type.rs](../disks-dbus/src/partition_type.rs): 2072
- [disks-ui/src/app.rs](../disks-ui/src/app.rs): 1780
- [disks-dbus/src/disks/drive.rs](../disks-dbus/src/disks/drive.rs): 1150
- [disks-ui/src/views/dialogs.rs](../disks-ui/src/views/dialogs.rs): 978
- [disks-dbus/src/disks/partition.rs](../disks-dbus/src/disks/partition.rs): 988
- [disks-dbus/src/disks/ops.rs](../disks-dbus/src/disks/ops.rs): 677
- [disks-dbus/src/disks/volume.rs](../disks-dbus/src/disks/volume.rs): 672
...
- **Evidence:**
  - `Message` enum and many UI actions live in the same file as app lifecycle and rendering: [disks-ui/src/app.rs](../disks-ui/src/app.rs#L327-L430)
  - The `view()` builds domain-specific panels and performs deep state access (with `unwrap()`): [disks-ui/src/app.rs](../disks-ui/src/app.rs#L562-L640)
  - The `update()` contains business operations and re-fetches drives repeatedly: [disks-ui/src/app.rs](../disks-ui/src/app.rs#L802-L910)
...
- **Evidence:**
  - Domain segmentation logic + UI filtering + logging embedded in the view module: [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs#L382-L520)
  - Massive dialog routing inside `VolumesControlMessage` handling (many “ignore” cases): [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs#L1688-L1905)
  - Unimplemented message variant used as a runtime log warning: [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs#L1746-L1748)
...
- **Evidence:**
  - Dialog views import dialog state from `crate::app` and message types from `views::volumes`: [disks-ui/src/views/dialogs.rs](../disks-ui/src/views/dialogs.rs#L1-L30)
  - Dialog state types are defined in the top-level app model file: [disks-ui/src/app.rs](../disks-ui/src/app.rs#L55-L220)
...
- **Evidence:**
  - Drive enumeration also builds nested volume trees (LUKS/LVM): [disks-dbus/src/disks/drive.rs](../disks-dbus/src/disks/drive.rs#L266-L360)
  - Same file contains SMART ATA selftest operations and partition creation, disk formatting, and preflight traversal: [disks-dbus/src/disks/drive.rs](../disks-dbus/src/disks/drive.rs#L980-L1105)
...
- **Evidence:**
  - `PARTITION_TYPES` is a 228-entry static array: [disks-dbus/src/partition_type.rs](../disks-dbus/src/partition_type.rs#L228-L280)
  - File is ~2072 LOC, dominated by data; has a TODO to wrap names with gettext: [disks-dbus/src/partition_type.rs](../disks-dbus/src/partition_type.rs#L54-L60)
...
- **Evidence:**
  - `VolumeModel` duplicates `encode_bytestring`, `decode_c_string_bytes`, `decode_mount_points`, etc.: [disks-dbus/src/disks/partition.rs](../disks-dbus/src/disks/partition.rs#L45-L114)
  - `VolumeNode` repeats the same patterns: [disks-dbus/src/disks/volume.rs](../disks-dbus/src/disks/volume.rs#L43-L112)
...
- **Evidence:**
  - DBus crate formatting: [disks-dbus/src/format.rs](../disks-dbus/src/format.rs)
  - UI crate formatting (very similar code, different style): [disks-ui/src/utils/format.rs](../disks-ui/src/utils/format.rs)
- **Suggested fix:** Use a single implementation (preferably `disks-dbus` re-exported for UI) or create a small `disks-common` crate for shared pure utilities.
- **Acceptance criteria:**
...
- **Evidence:**
  - Typo in message variant: `PasswordProectedUpdate`: [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs#L126-L140)
  - Typo in core data field `selected_partitition_type` used across UI and DBus: [disks-dbus/src/disks/create_partition_info.rs](../disks-dbus/src/disks/create_partition_info.rs#L1-L20)
  - Usage sites across files: [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs#L1739-L1745), [disks-dbus/src/disks/ops.rs](../disks-dbus/src/disks/ops.rs)
...
- **Evidence:**
  - `PartitionModel` is an alias to `VolumeModel`: [disks-dbus/src/disks/mod.rs](../disks-dbus/src/disks/mod.rs#L1-L20)
  - Tree representation uses `VolumeNode` with `VolumeKind`: [disks-dbus/src/disks/volume.rs](../disks-dbus/src/disks/volume.rs#L20-L42)
...
- **Evidence:**
  - `unwrap()` on active volumes control and selected segment: [disks-ui/src/app.rs](../disks-ui/src/app.rs#L573-L579)
  - `unwrap()` on active data in update path: [disks-ui/src/app.rs](../disks-ui/src/app.rs#L830-L833)
...
- **Evidence:**
  - `println!/eprintln!` used for operational errors and anomalies: [disks-ui/src/app.rs](../disks-ui/src/app.rs#L392-L410), [disks-ui/src/views/volumes.rs](../disks-ui/src/views/volumes.rs#L409-L458)
...
- Is `disks-dbus` meant to be a stable API consumed by other apps, or primarily internal to this UI?
...
- [disks-dbus/src/disks/volume.rs](../disks-dbus/src/disks/volume.rs)
